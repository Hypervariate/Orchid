...
BreakoutPaddleController::BreakoutPaddleController(){
	target = NULL;
}
BreakoutPaddleController::~BreakoutPaddleController(){

}
void BreakoutPaddleController::ProcessEventQueue(){
			...
			case INPUT_EVENT_KEY_DOWN:
				...
				switch(ev.GetEventValue()){
					...
					case 83:	//right
						...
						break;
					case 75:
						BreakoutBall* b = new BreakoutBall(target->GetX(), target->GetY() - target->GetHalfOfHeight() - 10, 0, -1);
